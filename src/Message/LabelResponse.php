...
class LabelResponse
{
    ...
    /**
     * @Tag(name="T101", key="depot_Code", type="string")
     * 
     * @var string
     */
    private $depotCode;
    ...
    /**
     * @Tag(name="T320", key="tour_number", type="string")
     * 
     * @var string
     */
    private $tourNumber;
    ...
    /**
     * @Tag(name="T310", key="inbound_sorting_code", type="string")
     * 
     * @var string
     */
    private $inboundSortingCode;
    
    /**
     * @Tag(name="T110", key="hub_indicator", type="string")
     * 
     * @var string
     */
    private $hubIndicator;
    ...
    /**
     * @Tag(name="T510", key="station_id", type="string")
     * 
     * @var string
     */
    private $stationId;
    ...
    /**
     * @Tag(name="T500", key="freight_system_code", type="string")
     * 
     * @var string
     */
    private $freightSystemCode;
    ...
    /**
     * @Tag(name="T979", key="gls_unit_number_customer_reference", type="string")
     * 
     * @var string
     */
    private $glsUnitNumberCustomerReference;
    ...
    /**
     * @Tag(name="TPT2", key="package_type_description", type="string")
     * 
     * @var string
     */
    private $packageTypeDescription;
    ...
    /**
     * @Tag(name="T8135", key="pick_Up", type="bool", options={"bool_values": {"F": true, "D": false}})
     * 
     * @var bool
     */
    private $pickUp;
    ...
    /**
     * @Tag(name="T8135", key="delivery", type="bool", options={"bool_values": {"D": true, "F": false}})
     * 
     * @var bool
     */
    private $delivery;
    ...
    /**
     * @Tag(name="T520", key="routing_date", type="datetime", format="dmY")
     * 
     * @var DateTime
     */
    private $routingDate;
    ...
    /**
     * @Tag(name="T540", key="shipping_date", type="datetime", format="d.m.Y")
     * 
     * @var DateTime
     */
    ...
    /**
     * @Tag(name="T541", key="shipping_time", type="datetime", format="H:i")
     * 
     * @var DateTime
     */
    ...
    /**
     * @Tag(name="T545", key="requested_delivery_date", type="datetime", format="d.m.Y")
     * 
     * @var DateTime
     */
     ...
     * @return string
     */
    public function getInboundSortingCode(): ?string
    {
        return $this->inboundSortingCode;
    }
    
    /**
     * @param string $inboundSortingCode = null
     * 
     * @return self
     */
     ...
     * @return string
     */
    public function getHubIndicator(): ?string
    {
        return $this->hubIndicator;
    }
    
    /**
     * @param string $hubIndicator = null
     * 
     * @return self
     */
     ...
     * @return string
     */
    public function getFreightSystemCode(): ?string
    {
        return $this->freightSystemCode;
    }
    
    /**
     * @param string $freightSystemCode = null
     * 
     * @return self
     */
     ...
     * @return string
     */
    public function getGlsUnitNumberCustomerReference(): ?string
    {
        return $this->glsUnitNumberCustomerReference;
    }
    
    /**
     * @param string $glsUnitNumberCustomerReference = null
     * 
     * @return self
     */
     ...
     * @return string
     */
    public function getPackageTypeDescription(): ?string
    {
        return $this->packageTypeDescription;
    }
    
    /**
     * @param string $packageTypeDescription = null
     * 
     * @return self
     */
    ...
    /**
     * @param bool $pickUp = null
     * 
     * @return self
     */
    public function setPickUp(bool $pickUp = null): self
    {
        $this->pickUp = $pickUp;
    ...
    /**
     * @param bool $delivery = null
     * 
     * @return self
     */
    public function setDelivery(bool $delivery = null): self
    {
     ...
     * @return DateTime
     */
    public function getRoutingDate(): ?DateTime
    {
        return $this->routingDate;
    }
    
    /**
     * @param DateTime $routingDate = null
     * 
     * @return self
     */
    public function setRoutingDate(DateTime $routingDate = null): self
    {
     ...
     * @return DateTime
     */
    public function getShippingTime(): ?DateTime
    {
     ...
     * @return string
     */
    public function getConsignorPhone(): ?string
    {
